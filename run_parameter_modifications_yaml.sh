...
for era in "${eras[@]}"; do
    for channel in "${channels[@]}"; do
        ...
        # ===========================
        # 3) Apply YAML-basierte Systematics
        # ===========================
        python3 modification_framework_with_yaml/main_modification.py \
            --path "$out_dir/used_settings" \
            --eras "$era" \
        ...
        #     --settings-folder "$out_dir/used_settings" \
        #     --output "$out_dir" \
        #     --yaml-base-path "/work/agaganidze/CMSSW_12_3_2/src/UserCode/TagAndProbe/output_2018UL_variations_muon/best_model_nominal/output_muon_2018UL_nominal_bestmodel/best_model_yamls" \
