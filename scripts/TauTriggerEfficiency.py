...
def parse_args():
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=["all"],
        choices=["all", "vloose", "loose", "medium", "tight", "vtight", "vvtight"],
    ...
    parser.add_argument("-e", "--era", type=str, required=True, help="Dataset era")
    parser.add_argument(
        "-o",
        "--output-file",
        type=str,
...
def make_plots(args):
    ...
    draw_options = [
        {"Title": "Data"},
        {"MarkerColor": 2, "LineColor": 2, "MarkerStyle": 21, "Title": "MC"},
        {"MarkerColor": 4, "LineColor": 4, "MarkerStyle": 21, "Title": "Embedded"},
    ]
