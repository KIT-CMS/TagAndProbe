...
from create_crosspog_json_systL import pt_eta_correction, CorrectionSet, emb_doublemuon_correction
...
def main(args):
    ...
    if args.channel == "embeddingselection":
        ...
        EmbSelEff = emb_doublemuon_correction(
            ...
            triggernames=["Trg17_pt_eta_bins", "Trg8_pt_eta_bins"], #hier habe ich beabsichtigt Trg17 entfernt, da dieser Probleme gemacht hat, vorher: triggernames=["Trg17_pt_eta_bins", "Trg8_pt_eta_bins"]
            era=args.era,
            outdir=f"{outdir}/jsons",
            data_only=True,
